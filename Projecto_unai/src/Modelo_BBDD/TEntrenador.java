...
public class TEntrenador {
    ...
    public static void insertatasistente(Entrenador ent) throws SQLException {
        BaseDatos.conectar();
    ...
    public static void modificarasistente(Entrenador ent) throws SQLException {
        BaseDatos.conectar();
    ...
    public static void borrarasistente(Entrenador ent) throws SQLException {
        BaseDatos.conectar();
