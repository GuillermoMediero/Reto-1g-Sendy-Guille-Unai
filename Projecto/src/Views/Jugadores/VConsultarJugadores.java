...
public class VConsultarJugadores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bConsultarJug = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        taJugador = new javax.swing.JTextArea();
        bCancelarJug = new javax.swing.JButton();
        jLabel2 = new javax.swing.JLabel();
        jPanel9 = new javax.swing.JPanel();
        tfNombreJug = new javax.swing.JTextField();
        ...
        jLabel1.setText("Consular Jugadores");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 60, -1, -1));

        bConsultarJug.setBackground(new java.awt.Color(0, 0, 0));
        bConsultarJug.setForeground(new java.awt.Color(255, 255, 255));
        bConsultarJug.setText("Consultar");
        bConsultarJug.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        bConsultarJug.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bConsultarJugActionPerformed(evt);
            }
        });
        jPanel1.add(bConsultarJug, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 120, 110, 20));

        taJugador.setBackground(new java.awt.Color(255, 255, 255));
        taJugador.setColumns(20);
        taJugador.setForeground(new java.awt.Color(0, 0, 0));
        taJugador.setRows(5);
        jScrollPane1.setViewportView(taJugador);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 180, 540, 230));

        bCancelarJug.setBackground(new java.awt.Color(0, 0, 0));
        bCancelarJug.setForeground(new java.awt.Color(255, 255, 255));
        bCancelarJug.setText("Cancelar");
        bCancelarJug.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        bCancelarJug.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bCancelarJugActionPerformed(evt);
            }
        });
        jPanel1.add(bCancelarJug, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 460, 120, 30));
        ...
        tfNombreJug.setBackground(new java.awt.Color(204, 204, 204));
        tfNombreJug.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        jPanel9.add(tfNombreJug, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 240, 40));
    ...
    private void bCancelarJugActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCancelarJugActionPerformed
        Controlador.cerrarVentana(this);
    }//GEN-LAST:event_bCancelarJugActionPerformed
    ...
    private javax.swing.JButton bCancelarJug;
    private javax.swing.JButton bConsultarJug;
    ...
    private javax.swing.JTextArea taJugador;
    private javax.swing.JTextField tfNombreJug;
