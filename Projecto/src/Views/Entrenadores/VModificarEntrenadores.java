...
public class VModificarEntrenadores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificar Entrenadores");
    ...
    private void lCerrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lCerrarMouseClicked
        Controlador.cancelarModificarEntrenador();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VModificarEntrenadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
