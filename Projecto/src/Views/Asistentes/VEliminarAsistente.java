 ...
 * @author 1GDAW12
 */
public class VEliminarAsistente extends javax.swing.JFrame {
    int xx;
    int xy; 
    Asistente asistente;
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar Asistente");
    ...
    private void lCerrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lCerrarMouseClicked
        Controlador.cancelarBorrarAsistente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VEliminarAsistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VEliminarAsistente().setVisible(true);
            }
        });
    }
